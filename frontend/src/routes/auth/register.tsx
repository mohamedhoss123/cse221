          ...
          <div className="space-y-6">
            <div>
              <h1 className="text-5xl font-light tracking-tight text-white mb-4">
                Join Our
                <span className="block font-semibold text-amber-400">Exclusive Circle</span>
              </h1>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="lg:hidden text-center mb-8">
            <h1 className="text-3xl font-light text-slate-900">
              Luxury
              <span className="block font-semibold text-amber-600">Stays</span>
            </h1>
          </div>
          ...
          <div className="mb-8">
            ...
            <p className="text-slate-600">
              Already a member?{' '}
              <Link to="/auth/login" className="text-amber-600 hover:text-amber-700 font-medium inline-flex items-center gap-1">
                Sign in
